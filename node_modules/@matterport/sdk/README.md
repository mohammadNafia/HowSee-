...
The Matterport SDK is actively maintained and updated, and over time your types may becoming outdated.  Be sure to keep track of updates by visiting our [change log](https://matterport.github.io/showcase-sdk/sdk_changelog.html).  You can update the types with the latest definitions at any time by running:
